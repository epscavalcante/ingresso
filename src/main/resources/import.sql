...
insert into candidate_status (name) values ('Inscrito');
insert into candidate_status (name) values ('Pré-Matrículado');
insert into candidate_status (name) values ('Classificado');
insert into candidate_status (name) values ('Aprovado');
